...
const AdminDashboardSidebar = ({isSidebarOpen}: {isSidebarOpen: boolean}) => {
  return (
    ...
    } lg:translate-x-0 md:w-3/12 w-full bg-[#3c4f81] text-white p-5 transition-transform duration-200 ease-in-out z-10`}>
      <h2 className="text-2xl font-semibold mb-6">Doctors Portal</h2>
