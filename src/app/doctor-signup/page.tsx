      ...
      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 bg-[#dee8fe] rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="p-8 md:p-12 space-y-4 bg-white">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 text-sm">
            ...
            {/* email  */}
            <div>
              <label htmlFor="title" className="block mb-[1px] text-textDark font-semibold">Title</label>

              <select
                id="doctor-title"
                {...register('doctorTitle', { required: 'Title is required' })}
                className=" block w-full py-3 px-4 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm text-gray-400"
              >
            ...
            <div className="flex justify-center gap-2">
              ...
              {/* Specialization */}
              <div className="w-1/2">
                <label htmlFor="specialization" className="block mb-[1px] text-textDark font-semibold">Specialization</label>
                <input
                  id="specialization"
                  type="text"
                  {...register("specialization", { required: "Specialization is required" })}
                  className={`w-full px-4 py-3 border ${errors.specialization ? "border-red-500" : "border-gray-300"
                    } rounded-md focus:outline-none  focus:ring-btnClr focus:border-btnClr`}
